...
export default function NewQcTemplatePage() {
  ...
  const [items, setItems] = useState<QcTemplateItem[]>([
    { itemDesc: "", criteria: "", tolerance: "", isMandatory: true, order: 1 },
  ]);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    startTransition(async () => {
      try {
        ...
        await createQcTemplate(data);
        toast("QC Template berhasil dibuat", "success");
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-xl font-bold text-white">QC Template Baru</h1>
          <p className="text-sm text-slate-400">Buat template checklist QC baru</p>
        </div>
      </div>
